...
<body>
    ...
    <main class="main-content">
        ...
        <section class="section">
            ...
            <div class="video-grid featured-grid">
                ...
                <a href="/video/<?= $video['slug'] ?>" class="video-card featured">
                    <div class="video-thumbnail">
                        <img src="<?= $video['featured_image_path'] ?>" alt="<?= htmlspecialchars($video['title']) ?>">
        ...
        <section class="section">
            ...
            <div class="video-grid">
                ...
                <a href="/video/<?= $video['slug'] ?>" class="video-card">
                    <div class="video-thumbnail">
                        <img src="<?= $video['thumbnail_path'] ?>" alt="<?= htmlspecialchars($video['title']) ?>">
                    </div>
                    <div class="video-info">
                        <h3 class="video-title"><?= htmlspecialchars($video['title']) ?></h3>
                        <span class="category-badge" style="background-color: <?= $video['background_color'] ?>; color: <?= $video['text_color'] ?>">
    ...
    <script src="/video-portal/public/js/main.js"></script>
</body>
</html>